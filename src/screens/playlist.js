...
render() {
    ...
    <div style={{width: '100%', height: '100%'}}>
      ...
      <div style={{ flexWrap:'wrap',display:'flex', width: '100%', height: '100%',
    ...
    //   backgroundColor:'white',
      paddingBottom:20,
          ...
          <div onClick ={()=>this.props.OnclickEachPlaylist('ChamanjeetSingh',1)}  className='box'  >
        ...
        ></img>
          ...
          <div  onClick ={()=>this.props.OnclickEachPlaylist('GurupreetSinghRinku',0)} className='box' >
